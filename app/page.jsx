    ...
    <div className="container mx-auto h-full">
      <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
        ...
        <div className="text-center xl:text-left order-2 xl:order-none ">
          ...
          Seasoned Tech Leader specializing in high-impact software development, automation, and digital transformation, 
          aligning strategic objectives to deliver measurable results and sustainable growth.
          </p>
        {/** button & socials */}
