...
const Button = ({ text, targetId }) => {
  ...
  return (
    <button
      onClick={handleClick}
      className="w-[250px] h-[54px] py-[5px] pl-[10px] pr-[5px] flex items-center rounded-full justify-between min-w-[200px] group bg-accent"
    >
      <div className=" rounded-full flex-1 text-center tracking-[1.2px] font-primary font-bold text-primary text-sm uppercase">
        {text}
      </div>
